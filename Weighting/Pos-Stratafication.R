...
setwd("/Users/kyle/Desktop/NCCU/RA/NDCDSD2022/NDCDSD-2022")
NDCDSD2022 <- read_sav('NDC111033我國家庭經濟支持功能之研究.sav') |> setDT()
...
pop <- read.csv("/Users/kyle/Downloads/opendata11202M030.csv", skip = 1)
...
# 多變數反覆加權 #
##################
example <- read.csv("/Users/kyle/Downloads/gender_age.csv", header = T, sep = ",")
head(example)
...
# 事後分層加權 #
################
genderXage <- table(example$gender, example$age)
addmargins(prop.table(genderXage))
...
pop_percent <- c(`(Intercept)` = 0.089, "2" = 0.140, "3" = 0.155, "4" = 0.111,
                 "5" = 0.082, "6" = 0.133, "7" = 0.161, "8" = 0.129)
